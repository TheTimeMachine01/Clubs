import AnimatedGradientBackground from '@/components/AnimatedGradientBackground'; // Adjust path if needed
...
export default function LoginScreen() {
    ...
    return (
        ...
        <>
            <AnimatedGradientBackground /> {/* Use the reusable component here */}
